...
pdfsubject={Vision Graphics and Interactive Systems - P9 Internship Report, Aalborg University},
pdftitle={Navicon Internship Report},
pdfborder={0 0 0}
]{hyperref}
...
\input{Sections/Techanalysis/introduction.tex}

\chapter{Discussion}\label{sec:discussion}
\input{Sections/Assessment/discussion.tex}

\chapter{Conclusion}
\input{Sections/Assessment/conclusion.tex}
\end{comment}
