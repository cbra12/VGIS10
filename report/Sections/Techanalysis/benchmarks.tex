...
\\\\
The majority of images come from another \gls{ilsvrc} challenge of single-object localisation. Where the aim was to only return a single object detection. Additional images were supplemented from flickr queries. Examples of images from the dataset can be seen in \figref{imagenet_ex}.
