...
\section{Main Challenges}\label{sec:probchallenges}
...
Robustness-related refers to the challenges in appearance within the both of intra-class and inter-class. Intra-class is the differences in appearance of objects which are of the same class. For example, as seen in \figref{intra_ex}, all of the images belong to the superclass chair, however, vary greatly in their overall appearance. 
