...
\draw [arrow] (in111.east) -- (in21.west);
\draw [arrow] (in121.east) -- (in21.west);
\draw [arrow] (in131.east) -- (in21.west);
\draw [arrow] (in141.east) -- (in21.west);
...
\draw [arrowred] (in211.east) -- (output1.west);
\draw [arrowred] (in221.east) -- (output1.west);
\draw [arrowred] (in231.east) -- (output1.west);
\draw [arrowred] (in241.east) -- (output1.west);
